...
function initializeUIkit() {
  ...
  scriptUIkit.onload = () => {
    ...
    scriptIcons.src = 'https://cdn.jsdelivr.net/gh/aparium/css-style/js/uikit-icons.js';
    scriptIcons.onload = () => {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const scriptIcons = document.createElement('script');
  scriptIcons.src = style.icons || 'https://cdn.jsdelivr.net/gh/aparium/css-style/js/uikit-icons.js';
  document.body.appendChild(scriptIcons);
});
